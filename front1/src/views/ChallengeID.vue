      ...
      <ul class="roc">
        <li>
          <div class="awuserdata">
            <li>{{ challenges.text }}</li>
            <p>answerA: {{ challenges.answerA }}</p>
            <p>answerB: {{ challenges.answerB }}</p>
            <p>answerC: {{ challenges.answerC }}</p>
            <p>answerD: {{ challenges.answerD }}</p>
          </div>
        </li>
      </ul>
      <div>
        <i
          id="awtestimonialsprev"
          class="awarrow awarrowleft"
          @click="AnswerChange()"
          >a</i
        >
        <br />
        <i
          id="awtestimonialsnext"
          class="awarrow awarrowright"
          @click="AnswerChange()"
          >a</i
        >
      </div>
