...
CREATE TABLE `challenge_answers` (
  ...
  `challenge_questions_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_entry_questions` (`challenge_questions_id`),
...
LOCK TABLES `challenge_answers` WRITE;
/*!40000 ALTER TABLE `challenge_answers` DISABLE KEYS */;
/*!40000 ALTER TABLE `challenge_answers` ENABLE KEYS */;
UNLOCK TABLES;
