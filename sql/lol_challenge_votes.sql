...
CREATE TABLE `challenge_votes` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_votes_challenge` (`challenge_questions_id`),
...
LOCK TABLES `challenge_votes` WRITE;
/*!40000 ALTER TABLE `challenge_votes` DISABLE KEYS */;
/*!40000 ALTER TABLE `challenge_votes` ENABLE KEYS */;
UNLOCK TABLES;
